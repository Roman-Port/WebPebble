...
namespace WebPebble.WebSockets.ycmd
{
    public static class YcmdProcess
    {
        ...
        public static void StartServer()
        {
            ...
            ProcessStartInfo startInfo = new ProcessStartInfo() { FileName = "/usr/bin/python3", Arguments = "echo 'ok' "/*+Program.config.ycmd_binary+ "  --options_file "+tempFile+" --port "+YcmdController.YCMD_PORT*/, };
